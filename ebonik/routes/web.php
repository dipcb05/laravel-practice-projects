...
Route::get('/borws', function (Request $request) {
    $users = Borrow::paginate(10);
    return $users;
});
...
Route::put('/borrows/{borrow}/update', [BorrowController::class, 'update']);
Route::delete('/borrows/{borrow}/delete', [BorrowController::class, 'destroy']);
